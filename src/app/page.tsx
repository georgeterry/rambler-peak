...
export const metadata: Metadata = {
  ...
  description:
    'Rambler Peak makes ultralight camping mats and pillows, engineered in the Peak District. The DreamLite camping mat with integrated pillow: 590 g, three-season warmth, free UK delivery.',
